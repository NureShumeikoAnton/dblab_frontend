...
export const STAGE_RULES = {
    ...
    'FDs': [
        { text: 'На кожній таблиці визначена принаймні одна функціональна залежність', type: 'auto', autoKey: 'fds_table_coverage' },
        { text: 'Кожен неключовий атрибут залежить хоча б від чогось (щонайменше від первинного ключа)', type: 'auto', autoKey: 'fds_attr_determined' },
        { text: 'У кожній таблиці є залежність, де всі атрибути визначаються первинним ключем (простим чи складеним)', type: 'auto', autoKey: 'fds_pk_determinant' },
