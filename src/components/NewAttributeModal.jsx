...
const NewAttributeModal = ({ isOpen, mode, onClose, onSubmit, initialName = '', initialDataType = 'VARCHAR' }) => {
    ...
    const subtitle = isEdit
        ? 'Зміни застосовуються до всіх етапів'
        : mode === 'global'
            ? 'Доступно з: 1НФ (усі етапи)'
            : 'Доступно з: цього етапу';
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal" onClick={(e) => e.stopPropagation()}>
                <div className="modal__header">
                    <div>
                        <h2 className="modal__title">{isEdit ? 'Редагувати атрибут' : 'Додати атрибут'}</h2>
